            ...
            <div className="mt-8 pt-9">
                <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
                    <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
                        ...
                        <div className="md:w-[316px] ">
                            <p className="text-[18px] font-medium text-black lg:text-left md:text-left">Quick Links</p>
                            <div className="mt-[15px] text-black/[60%]">
                                <ul className='lg:text-left md:text-left'>
                                    <li>
                                        <a href="/" className="text-[15px] font-medium text-black hover:text-black">
                                            Home
                                        </a>
                                    </li>
                                    <li>
                        ...
                        <div className="md:w-[316px] p-4 bg-yellow-400 rounded">
                            <div className="mt-[23px] flex">
                                ...
                                <div className="ml-[18px]">
                                    <a href="tel:+911800123444" className="font-Inter text-[14px] font-medium text-black">+91 9348228808</a>
                            ...
                            <div className="mt-[23px] flex">
                                ...
                                <div className="ml-[18px]">
                                    <a href="mailto:support@englishyaari.com" className="font-Inter text-[14px] font-medium text-black">support@englishyaari.com</a>
                            ...
                            <div class="mt-[23px] flex">
                                ...
                                <div class="ml-[18px]">
                                    <a href="mailto:help@lorem.com" class="font-Inter text-[14px] font-medium text-black">MIG-196, BBSR, INDIA, 751024</a>
                                    <p class="font-Inter text-[12px] font-medium text-black text-left">Address</p>
                                </div>
                            </div>
                        </div>
