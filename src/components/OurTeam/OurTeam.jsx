    ...
    <h2 className="text-3xl font-extrabold text-gray-800 inline-block relative after:absolute after:w-4/6 after:h-1 after:left-0 after:right-0 after:-bottom-4 after:mx-auto after:bg-yellow-400 after:rounded-full">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 max-md:justify-center mt-12">
            ...
            <div className="flex items-center max-sm:flex-col bg-gray-100 gap-4 rounded-lg overflow-hidden hover:scale-[1.02] transition-all">
                <img src={priti} className="w-full sm:h-60 object-cover" />
                ...
                <div className="p-4">
                    ...
                    <div className="mt-4">
                        <p className="text-gray-600 text-sm leading-relaxed text-justify">She is a talented software engineer skilled in developing efficient solutions and staying current with the latest technologies. She is known for her problem-solving abilities and delivering high-quality software.</p>
                    </div>
            ...
            <div className="flex items-center max-sm:flex-col bg-gray-100 gap-4 rounded-lg overflow-hidden hover:scale-[1.02] transition-all">
                <img src={tejender} className="w-full sm:h-60 object-cover" />
                ...
                <div className="p-4">
                    ...
                    <div className="mt-4">
                        <p className="text-gray-600 text-sm leading-relaxed text-justify">He specializes in creating visually appealing and user-friendly websites with a focus on seamless user experiences.</p>
                    </div>
            ...
            <div className="flex items-center max-sm:flex-col bg-gray-100 gap-4 rounded-lg overflow-hidden hover:scale-[1.02] transition-all">
                <img src={sagar} className="sm:w-full lg:w-80 md:w-80 sm:h-60 object-cover" />
                ...
                <div className="p-4">
                    ...
                    <div className="mt-4">
                        <p className="text-gray-600 text-sm leading-relaxed text-justify">He is  is a talented Full Stack Developer with expertise in both frontend and backend technologies. He excels in building scalable, efficient web applications.</p>
                    </div>
            ...
            <div className="flex items-center max-sm:flex-col bg-gray-100 gap-4 rounded-lg overflow-hidden hover:scale-[1.02] transition-all">
                <img src={amlan} className="w-full sm:h-60 object-cover" />
                ...
                <div className="p-4">
                    ...
                    <div className="mt-4">
                        <p className="text-gray-600 text-sm leading-relaxed text-justify">Amlan Baral is a key member of the Admin Department, handling office coordination, scheduling, and administrative tasks with efficiency and attention to detail.</p>
                    </div>
