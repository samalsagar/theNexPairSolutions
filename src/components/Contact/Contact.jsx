    ...
    return (
        <div className='mt-20'>
           <h2 className="text-3xl font-extrabold text-gray-800 inline-block relative after:absolute after:w-4/6 after:h-1 after:left-0 after:right-0 after:-bottom-4 after:mx-auto after:bg-yellow-400 after:rounded-full">
            ...
            "We'd love to hear from you! Whether you have a question, feedback, or need assistance, our team is here to help. Feel free to reach out through any of the following methods, and we'll get back to you as soon as possible."
            </p>
                ...
                <div className="grid lg:grid-cols-3 items-center">
                    <div className="grid sm:grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:px-4">
                        <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                            ...
                            <p className="text-sm text-gray-600 mt-2"> MIG-196, BBSR, INDIA, 751024</p>
                        </div>
                        <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                            ...
                            <p className="text-sm text-gray-600 mt-2">+91 9348228808</p>
                        </div>
                        <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                            ...
                            <p className="text-sm text-gray-600 mt-2">
                                <span className="inline lg:block">thenexpairsolutions@</span>
                                <span className="inline lg:block">gmail.com</span>
                            </p>
                    ...
                    <div className="lg:col-span-2 bg-[#0a4275] rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8">
                        <h2 className="text-3xl text-white text-center font-bold mb-6">Let's lalk about your idea
                        </h2>
                        <form>
